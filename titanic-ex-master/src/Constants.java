public class Constants {
    public static final String PATH_TO_DATA_FILE = "titanic-ex-master\\src\\data\\titanic.csv";
    public static final String PATH_TO_FILE_COUNT = "titanic-ex-master/src/data/currentFileToWrite.txt";
